export default [
	{
		...
		description:
			"'1984' — культовый роман Джорджа Оруэлла, действия которого разворачивается в тоталитарном, бюрократическом государстве, где процветает пропаганда и цензура, а тотальная слежка ведется круглосуточно, и где один человек решил побороться за право быть индивидуальной личностью.",
		thumbnail:
	...
	},
	{
		...
		thumbnail:
			"https://ew.com/thmb/K118uZidJ1cVI1g_mv1ND46pkFs=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/9781408855706-848b562ab5024143975103c91527e052.jpg",
	},
	{
		id: 5,
